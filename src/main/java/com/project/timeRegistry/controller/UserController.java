...
public class UserController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Find a user by its identifier with success"),
            @ApiResponse(responseCode = "404", description = "User not found by its identifier"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Register a user with success"),
            @ApiResponse(responseCode = "400", description = "UserRequest invalid"),
            @ApiResponse(responseCode = "422", description = "Login already exists"),
            @ApiResponse(responseCode = "500", description = "Internal error")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Update a user with success"),
            @ApiResponse(responseCode = "400", description = "UserRequest invalid"),
            @ApiResponse(responseCode = "404", description = "User not found by its identifier"),
            @ApiResponse(responseCode = "422", description = "Login already exists"),
            @ApiResponse(responseCode = "500", description = "Internal error")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Set user's status to inactive with success"),
            @ApiResponse(responseCode = "404", description = "User not found by its identifier"),
            @ApiResponse(responseCode = "500", description = "Internal error")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Set user's status to active with success"),
            @ApiResponse(responseCode = "404", description = "User not found by its identifier"),
            @ApiResponse(responseCode = "500", description = "Internal error")
    })
